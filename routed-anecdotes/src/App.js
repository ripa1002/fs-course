    ...
    <ListGroup>
      {anecdotes.map(anecdote =>
        <ListGroupItem key={anecdote.id}>
          ...
          <span className="badge badge-default badge-pill"> votes: {anecdote.votes}</span> 
        </ListGroupItem>
      )}
    </ListGroup>
  </div>
    ...
    <Grid>
      <Row className="show-grid">
        <Col xs={12} md={8}>
          ...
          <Image src="http://www.daviddarling.info/images/Babbage.jpg" />
        </Col>
      </Row>
    </Grid>
  </div>
...
class App extends React.Component {
  ...
  addNew = (anecdote) => {
    ...
    this.setState({
      ...
      notification: `You added new anecdote: ${anecdote.content}`,
